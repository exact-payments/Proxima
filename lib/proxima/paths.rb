  ...
  module Paths
    module ClassMethods
      ...
      def find_by_id_path(find_by_id_path = nil)
        ...
        @find_by_id_path ||= ->(m) { "#{@base_uri.call}/#{m[:id]}" }
      end
      ...
      def update_by_id_path(update_by_id_path = nil)
        ...
        @update_by_id_path ||= ->(m) { "#{@base_uri.call}/#{m[:id]}" }
      end
      ...
      def delete_by_id_path(delete_by_id_path = nil)
        ...
        @delete_by_id_path ||= ->(m) { "#{@base_uri.call}/#{m[:id]}" }
      end
      ...
      def restore_by_id_path(restore_by_id_path = nil)
        ...
        @restore_by_id_path ||= ->(m) { "#{@base_uri.call}/restore/#{m[:id]}" }
      end
    end
